...
StaticComponentsBlock::StaticComponentsBlock(
        ...
        m_background(position, size), m_shared_context(sharedContext) {
...
void StaticComponentsBlock::addStaticComponent(BaseLogicalComponent &&data) {
...
std::optional<std::pair<BaseLogicalComponent, sf::Vector2f>> StaticComponentsBlock::getClickedComponentData(const sf::Vector2f &position) {
    for (auto &component: m_components) {
