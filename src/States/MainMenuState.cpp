...
MainMenuState::MainMenuState(StateManager *stateManager) :
    ...
    m_start_game_btn.setPosition(
            {
                    ...
                    (window_size.y - m_btn_size.y * 3 - m_btn_offset * 2) / 2.f
            }
    );
    ...
    m_choose_level_btn.setPosition(
            {
                    (window_size.x - m_btn_size.x) / 2.f,
                    (window_size.y - m_btn_size.y * 3 - m_btn_offset * 2) / 2.f + m_btn_size.y + m_btn_offset
            }
    );
    ...
    m_quit_game_btn.setPosition(
            {
                    (window_size.x - m_btn_size.x) / 2.f,
                    (window_size.y - m_btn_size.y * 3 - m_btn_offset * 2) / 2.f + m_btn_size.y * 2 + m_btn_offset * 2
            }
    );
